...
import { SignOut } from "../../store/Actions/ActionTypes";
...
import Button from "admin/components/CustomButtons/Button";
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "تانيا أندرو" : this.props.user}
                secondary={
                  <b
                    className={
                      caret +
                ...
                <ListItem className={classes.collapseItem}>
                  <ListItem className={classes.collapseItem}>
                    <div style={{width: '80%',textAlign: "center",marginLeft: "10%"}}>
                       <Button color="facebook" round fullWidth 
                        onClick={() => this.props.SignOut()}>Log Out</Button>
                    </div>
                  </ListItem>
                </ListItem>
              </List>
